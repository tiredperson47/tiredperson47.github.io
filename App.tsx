...
const MainLayout: React.FC = () => {
  ...
  return (
    <div className={`flex h-screen text-[#e6edf3] overflow-hidden select-none transition-colors duration-300 ${theme === 'light' ? 'light-theme' : 'bg-[#0d1117]'}`}>
      <Sidebar 
      ...
      <div className="flex-1 flex flex-col min-w-0 transition-all duration-300">
        ...
        {/* Footer Bar */}
        <footer className="h-8 bg-[#161b22] border-t border-[#30363d] flex items-center px-4 justify-between text-[10px] mono uppercase tracking-widest text-[#8b949e]">
